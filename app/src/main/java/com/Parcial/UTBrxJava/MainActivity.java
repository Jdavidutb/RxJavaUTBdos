...
public class MainActivity extends AppCompatActivity {
    ...
    private static String TAG = "RX_JAVA_UTB";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hnService.getLibros()
                ...
                .map(Libros -> getItemObservables(hnService, Libros))
                .flatMap(Observable::merge)
                .doOnNext(hnItem1 -> Log.d(TAG, "item received " + hnItem1.id))
                .take(4)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe((hnArticulos) -> addItemToList(hnArticulos, adapter),
    ...
    private List<Observable<RestClient.HNItem>> getItemObservables(RestClient.HNService hnService,
                                                                   RestClient.nuevosLibros newStories) {
